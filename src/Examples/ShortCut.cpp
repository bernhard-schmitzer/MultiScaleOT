...
int W2Grid() {
	...
	// the more general base class TMultiScaleSetup uses marginals with support on arbitrary point clouds
...
int WpSphere() {
	...
	TMultiScaleSetupSphere MultiScaleSetupX(posX.data,muXdat.data(),posX.dimensions[0],posX.dimensions[1],depth,false,false,false);
	msg=MultiScaleSetupX.Setup();	
	if(msg!=0) {
		printf("%d\n",msg);
		return msg;
	...
	TMultiScaleSetupSphere MultiScaleSetupY(posX.data,muYdat.data(),posX.dimensions[0],posX.dimensions[1],depth,false,false,false);
	msg=MultiScaleSetupY.Setup();	
	if(msg!=0) {
		printf("%d\n",msg);
		return msg;
	...
	msg=MultiScaleSetupX.TMultiScaleSetup::SetupRadii();	
